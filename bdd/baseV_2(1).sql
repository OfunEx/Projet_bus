...
CREATE TABLE Bus (id_bus int AUTO_INCREMENT NOT NULL, num_bus INT(4), PRIMARY KEY (id_bus) ) ENGINE=InnoDB;  
DROP TABLE IF EXISTS Trajet ; 
CREATE TABLE Trajet (id_trajet int AUTO_INCREMENT NOT NULL, id_arret INT NOT NULL, id_arret_arrivee INT NOT NULL, PRIMARY KEY (id_trajet) ) ENGINE=InnoDB;  
DROP TABLE IF EXISTS Arret ; 
CREATE TABLE Arret (id_arret int AUTO_INCREMENT NOT NULL, nom_arret VARCHAR(20), PRIMARY KEY (id_arret) ) ENGINE=InnoDB;  
DROP TABLE IF EXISTS lier ; 
CREATE TABLE lier (id_bus int AUTO_INCREMENT NOT NULL, id_trajet INT NOT NULL, PRIMARY KEY (id_bus,  id_trajet) ) ENGINE=InnoDB;  
DROP TABLE IF EXISTS Arret_int ; 
CREATE TABLE Arret_int (id_trajet int AUTO_INCREMENT NOT NULL, id_arret INT NOT NULL, ordre_arret INT(3), PRIMARY KEY (id_trajet,  id_arret) ) ENGINE=InnoDB;  
DROP TABLE IF EXISTS passage ; 
CREATE TABLE passage (id_bus int AUTO_INCREMENT NOT NULL, id_arret INT NOT NULL, horaire TIME, PRIMARY KEY (id_bus,  id_arret) ) ENGINE=InnoDB;
